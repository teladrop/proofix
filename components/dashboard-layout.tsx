                ...
                {navigation.map((item) => (
                  <SidebarMenuItem key={item.id}>
                    <SidebarMenuButton
                      ...
                      className={`w-full justify-start h-11 px-3 rounded-lg transition-all duration-200 group ${
                        currentPage === item.id
                    ...
                    >
                      <item.icon
                        className={`h-5 w-5 ${
                          currentPage === item.id ? "text-white" : "text-gray-500 group-hover:text-gray-900"
                        }`}
                      />
